...
const Bill = ({ billData }) => {
  return (
    <html className="">
      <head>
        <title>Checkup Bill - Oza-Lab Laboratory</title>
      </head>
      <body>
        <h1>Checkup Bill - Oza-Lab Laboratory</h1>

        <h2>Patient Information</h2>
        <p>
          <strong>Name:</strong> {billData.patientName}
        </p>
        <p>
          <strong>Date of Birth:</strong> {billData.patientDOB}
        </p>
        <p>
          <strong>Gender:</strong> {billData.patientGender}
        </p>
        <p>
          <strong>Contact Number:</strong> {billData.patientPhoneNumber}
        </p>
        <p>
          <strong>Email:</strong> {billData.patientEmail}
        </p>

        <h2>Test Details</h2>
        {console.log(billData)}
        {console.log(billData.bill)}
        <h4>Test Name: {billData.bill.testName}</h4>
        <h4>Test Price: Rs. {billData.bill.price}</h4>
        <h4>Bill Amount: Rs. {billData.bill.price}</h4>
